...
params = {
  'api_token': data['api_token_acuvue'],
  'from': yesterday,
  'to': yesterday
}
...
with open('Acuvue_daily_iOS_Yesterday.csv','w') as w:
    w.write(text)

print('Initial report processed and saved as Acuvue_daily_iOS_Yesterday.csv.')


andreport = 'Acuvue_daily_Yesterday.csv'
...
with open(andreport, mode='r') as csv_data:
    ...
    for row in csv_data_list:
        cursor.execute("""
                   ...
                   VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,'iOS')""",
