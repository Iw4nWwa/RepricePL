...
with open('Acuvue_daily_Andr_Yesterday.csv','w') as w:
    w.write(text)

print('Initial report processed and saved as Acuvue_daily_Andr_Yesterday.csv.')


andreport = 'Acuvue_daily_Andr_Yesterday.csv'
